...
export function Galaxy({
  ...
  const uniformFocal = useMemo(
    () => new Float32Array([focalX, focalY]),
    [focalX, focalY]
  );
  const uniformRotation = useMemo(
    () => new Float32Array([rotX, rotY]),
    [rotX, rotY]
  );
  ...
  useEffect(() => {
    ...
    ctn.style.backgroundColor = ctn.style.backgroundColor || "#020617";
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uFocal: { value: uniformFocal },
        uRotation: { value: uniformRotation },
